...
public class KeyPad extends JDialog implements ActionListener {
	...
	public KeyPad(int maxLength) {
		this.maxLength = maxLength;
		runKeyPad();
	}
	
	//생성자 매개변수를 True만 줄때 최대입력을 4자리로 제한하고 사용자가 보이는 부분이 *로 출력됨
	public KeyPad(boolean securityOutput) {
		maxLength = 4;
	...
	public KeyPad(int maxLength,boolean securityOutput) {
		this.maxLength = maxLength;
		this.securityOutput = securityOutput;
		runKeyPad();
	}
